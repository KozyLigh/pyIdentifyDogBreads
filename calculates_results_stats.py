...
def calculates_results_stats(results_dic):
    ...
    for key, value in results_dic.items():
        if value[3]==1 and value[4] ==1:
            n_correct_dogs=n_correct_dogs+1
        if value[3]==1:
            n_dogs_img=n_dogs_img+1
        if value[3]==0 and value[4] ==0:
            n_correct_notdogs=n_correct_notdogs+1
        if value[3]==1 and value[2] ==1:
            n_correct_breed=n_correct_breed+1
        if value[2]==1:
            n_match=n_match+1
    ...
    results_stats_dic["n_dogs_img"]=n_correct_notdogs
    results_stats_dic["n_correct_dogs"]=n_correct_notdogs
